...
urlpatterns = patterns('home.views',
    ...
    url(r'^noticia/(?P<not_id>\d+)/(?P<url_amigable>[-\w]+)/$', 'ver_noticia', name='ver_noticia'),
    url(r'^galeria/(?P<gal_id>\d+)/(?P<url_amigable>[-\w]+)/$', 'ver_galeria', name='ver_galeria'),
    ...
    url(r'^revista-online/(?P<rev_id>\d+)/(?P<url_amigable>[-\w]+)/$', 'ver_revista', name='ver_revista'),
