...
#        'NAME': 'tvrobles',                      # Or path to database file if using sqlite3.        'USER': 'postgres',                      # Not used with sqlite3.
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2', # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'dfbg33ulku968q',                      # Or path to database file if using sqlite3.
        'USER': 'nfbkcuwrsibgky',                      # Not used with sqlite3.
        'PASSWORD': 'sUJd1Xfqwx9-8WNLnUF2cG4q-H',                  # Not used with sqlite3.        'HOST': 'ec2-23-23-201-251.compute-1.amazonaws.com',                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '5432',                      # Set to empty string for default. Not used with sqlite3.
    }
}
...
#SECRET_KEY = '+e+5mdxp^6-h#!7hquz*2e=0tfm-_+92e2h=!0$(d%9zm*_j0m'
SECRET_KEY = 'x!y3)fik4nkv+!fw=sx&hu19$+f(vof5j0g0dzkexc5q#ipe7@'
